!(function(t) {
  ...
  (i.m = t),
    ...
    (i.t = function(t, n) {
      ...
      if ((i.r(a), Object.defineProperty(a, 'default', { enumerable: !0, value: t }), 2 & n && 'string' != typeof t))
        for (var e in t)
          i.d(
            a,
            e,
  ...
  function(t, n, i) {
    ...
    function e(t, n) {
      ...
      (this._maxEntries = Math.max(4, t || 9)), (this._minEntries = Math.max(2, Math.ceil(0.4 * this._maxEntries))), n && this._initFormat(n), this.clear();
    }
    function r(t, n, i) {
    ...
    e.prototype = {
      ...
      _build: function(t, n, i, a) {
        ...
        for (p(t, n, i, f, this.compareMinX), h = n; h <= i; h += f)
          for (p(t, h, (c = Math.min(h + f - 1, i)), u, this.compareMinY), l = h; l <= c; l += u) (m = Math.min(l + u - 1, c)), e.children.push(this._build(t, l, m, a - 1));
        ...
        for (var e, r, o, s, h, l, c, u, f, d; a.push(n), !n.leaf && a.length - 1 !== i; ) {
          for (c = u = 1 / 0, e = 0, r = n.children.length; e < r; e++)
            (h = m((o = n.children[e]))),
              (f = t),
              (d = o),
              (l = (Math.max(d.maxX, f.maxX) - Math.min(d.minX, f.minX)) * (Math.max(d.maxY, f.maxY) - Math.min(d.minY, f.minY)) - h) < u
                ? ((u = l), (c = h < c ? h : c), (s = o))
                : l === u && h < c && ((c = h), (s = o));
          n = s || n.children[0];
        }
      ...
      _chooseSplitIndex: function(t, n, i) {
        ...
        for (l = c = 1 / 0, a = n; a <= i - n; a++)
          (e = s(t, 0, a, this.toBBox)),
            ...
            void 0,
            void 0,
            (_ = Math.max(f.minX, d.minX)),
            (p = Math.max(f.minY, d.minY)),
            (x = Math.min(f.maxX, d.maxX)),
            (g = Math.min(f.maxY, d.maxY)),
            (o = Math.max(0, x - _) * Math.max(0, g - p)),
            (h = m(e) + m(r)),
            o < l ? ((l = o), (u = a), (c = h < c ? h : c)) : o === l && h < c && ((c = h), (u = a));
        return u;
      },
          ...
          for (; r > e; ) {
            if (r - e > 600) {
              var s = r - e + 1,
                ...
                m = 0.5 * Math.sqrt((l * c * (s - c)) / s) * (h - s / 2 < 0 ? -1 : 1),
      ...
      var n = (t.Layer ? t.Layer : t.Class).extend({
        ...
        onAdd: function(t) {
          (this._map = t),
            ...
            t._zoomAnimated && t.on('zoomanim', this._animateZoom, this);
        },
        onRemove: function(t) {
          this.options.pane ? this.getPane().removeChild(this._canvas) : t.getPanes().overlayPane.removeChild(this._canvas),
            ...
            t._zoomAnimated && t.off('zoomanim', this._animateZoom, this);
        },
        addTo: function(t) {
        ...
        _addMarker: function(n, i, a) {
          (n._map = this._map),
            ...
            this._latlngMarkers || ((this._latlngMarkers = new rbush()), (this._latlngMarkers.dirty = 0), (this._latlngMarkers.total = 0)),
            t.Util.stamp(n);
        ...
        _drawMarker: function(t, n) {
          ...
          else if (i._imageLookup[a]) (t.canvas_img = i._imageLookup[a][0]), !1 === i._imageLookup[a][1] ? i._imageLookup[a][2].push([t, n]) : (i._drawImage(t, n), i._drawText(t, n));
          else {
            var e = new Image();
            (e.src = a),
              (t.canvas_img = e),
